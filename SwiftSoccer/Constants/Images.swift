...
internal enum Asset {
  internal static let launchScreenImage = ImageAsset(name: "LaunchScreenImage")
  internal static let icNoInternet = ImageAsset(name: "ic_no_internet")
  internal static let icSoccerBall = ImageAsset(name: "ic_soccer_ball")
  internal static let icCalendar = ImageAsset(name: "ic_calendar")
  internal static let icMenu = ImageAsset(name: "ic_menu")
  internal static let icScorers = ImageAsset(name: "ic_scorers")
  internal static let icStanding = ImageAsset(name: "ic_standing")
  ...
  internal static let white80 = ColorAsset(name: "white80")
  internal static let launchScreenColor = ColorAsset(name: "LaunchScreenColor")
  internal static let homeBackgroundColor = ColorAsset(name: "homeBackgroundColor")
}
